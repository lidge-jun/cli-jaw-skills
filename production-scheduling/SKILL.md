...
description: >
  ...
  and bottleneck resolution in discrete and batch manufacturing. Includes
  TOC/drum-buffer-rope, SMED, OEE analysis, disruption response frameworks,
  and ERP/MES interaction patterns.
---
...
Discrete and batch manufacturing scheduling across machining, assembly, finishing, and packaging work centers. Integrates with ERP (SAP PP, Oracle Manufacturing, Epicor), finite-capacity scheduling tools (Preactor, PlanetTogether, Opcenter APS), MES, and CMMS.
