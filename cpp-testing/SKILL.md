...
- Product feature implementation without test changes
...
- Keep unit tests free of real-time and network dependencies
- Use condition variables or latches instead of sleeps for synchronization
- Use real value objects rather than mocking simple types
- Use structured assertions rather than brittle string matching for logs
