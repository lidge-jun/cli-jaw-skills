...
# 左侧珊瑚橙大色块 (装饰区: 0-12cm)
officecli add "$OUTPUT" '/slide[1]' --type shape --prop geometry=rect --prop fill=FF6B6B --prop x=0cm --prop y=0cm --prop width=12cm --prop height=19.05cm

# 右下角装饰色块 (装饰区)
officecli add "$OUTPUT" '/slide[1]' --type shape --prop geometry=rect --prop fill=4ECDC4 --prop x=28cm --prop y=11cm --prop width=5.87cm --prop height=8.05cm

# 右上角装饰色块 (装饰区)
officecli add "$OUTPUT" '/slide[1]' --type shape --prop geometry=rect --prop fill=FFE66D --prop x=29cm --prop y=0cm --prop width=4.87cm --prop height=5cm

# 装饰圆 (在装饰区域内) - 手动定义最多3个
officecli add "$OUTPUT" '/slide[1]' --type shape --prop geometry=ellipse --prop fill=FF6B6B --prop opacity=0.3 --prop x=5cm --prop y=12cm --prop width=6cm --prop height=6cm
officecli add "$OUTPUT" '/slide[1]' --type shape --prop geometry=ellipse --prop fill=FFE66D --prop opacity=0.4 --prop x=3cm --prop y=8cm --prop width=4cm --prop height=4cm
officecli add "$OUTPUT" '/slide[1]' --type shape --prop geometry=ellipse --prop fill=4ECDC4 --prop opacity=0.3 --prop x=6cm --prop y=3cm --prop width=3cm --prop height=3cm

# 主内容卡片 (内容区: 14-28cm，不与右侧装饰重叠)
officecli add "$OUTPUT" '/slide[1]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=14cm --prop y=2cm --prop width=13cm --prop height=15cm

# 卡片内容
officecli add "$OUTPUT" '/slide[1]' --type shape --prop geometry=roundRect --prop fill=FF6B6B --prop x=16cm --prop y=3.5cm --prop width=5cm --prop height=1.2cm
...
officecli add "$OUTPUT" '/slide[1]' --type shape --prop geometry=rect --prop fill=FFE66D --prop x=16cm --prop y=12cm --prop width=8cm --prop height=0.15cm
...
# 底部装饰线
officecli add "$OUTPUT" '/slide[1]' --type shape --prop geometry=rect --prop fill=FF6B6B --prop x=0cm --prop y=18.8cm --prop width=33.87cm --prop height=0.25cm

# 左侧装饰圆点 (手动定义3个)
officecli add "$OUTPUT" '/slide[1]' --type shape --prop geometry=ellipse --prop fill=FFFFFF --prop opacity=0.6 --prop x=8cm --prop y=15cm --prop width=0.4cm --prop height=0.4cm
officecli add "$OUTPUT" '/slide[1]' --type shape --prop geometry=ellipse --prop fill=FFE66D --prop opacity=0.5 --prop x=9cm --prop y=16cm --prop width=0.3cm --prop height=0.3cm
officecli add "$OUTPUT" '/slide[1]' --type shape --prop geometry=ellipse --prop fill=4ECDC4 --prop opacity=0.4 --prop x=10cm --prop y=15.5cm --prop width=0.25cm --prop height=0.25cm
...
# 左侧黄色装饰条 (装饰区)
officecli add "$OUTPUT" '/slide[2]' --type shape --prop geometry=rect --prop fill=FFE66D --prop x=0cm --prop y=0cm --prop width=5cm --prop height=19.05cm

# 右下角装饰色块
officecli add "$OUTPUT" '/slide[2]' --type shape --prop geometry=rect --prop fill=4ECDC4 --prop x=27cm --prop y=13cm --prop width=6.87cm --prop height=6.05cm
...
# 左侧装饰圆点 (手动定义3个)
officecli add "$OUTPUT" '/slide[2]' --type shape --prop geometry=ellipse --prop fill=FF6B6B --prop opacity=0.3 --prop x=1cm --prop y=5cm --prop width=0.5cm --prop height=0.5cm
officecli add "$OUTPUT" '/slide[2]' --type shape --prop geometry=ellipse --prop fill=4ECDC4 --prop opacity=0.4 --prop x=2cm --prop y=7cm --prop width=0.4cm --prop height=0.4cm
officecli add "$OUTPUT" '/slide[2]' --type shape --prop geometry=ellipse --prop fill=FFE66D --prop opacity=0.3 --prop x=1.5cm --prop y=9cm --prop width=0.35cm --prop height=0.35cm
...
officecli add "$OUTPUT" '/slide[2]' --type shape --prop geometry=rect --prop fill=FF6B6B --prop x=7cm --prop y=10cm --prop width=6cm --prop height=0.15cm

# 数据卡片 (内容区域内，不与右侧装饰重叠)
# 卡片1: x=7cm
officecli add "$OUTPUT" '/slide[2]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=7cm --prop y=11.5cm --prop width=6cm --prop height=4cm
officecli add "$OUTPUT" '/slide[2]' --type shape --prop geometry=rect --prop fill=FF6B6B --prop x=7cm --prop y=11.5cm --prop width=6cm --prop height=0.2cm
...
# 卡片2: x=14cm
officecli add "$OUTPUT" '/slide[2]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=14cm --prop y=11.5cm --prop width=6cm --prop height=4cm
officecli add "$OUTPUT" '/slide[2]' --type shape --prop geometry=rect --prop fill=FFE66D --prop x=14cm --prop y=11.5cm --prop width=6cm --prop height=0.2cm
...
officecli add "$OUTPUT" '/slide[2]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=21cm --prop y=11.5cm --prop width=5.5cm --prop height=4cm
officecli add "$OUTPUT" '/slide[2]' --type shape --prop geometry=rect --prop fill=4ECDC4 --prop x=21cm --prop y=11.5cm --prop width=5.5cm --prop height=0.2cm
...
# 顶部装饰条
officecli add "$OUTPUT" '/slide[3]' --type shape --prop geometry=rect --prop fill=FF6B6B --prop x=0cm --prop y=0cm --prop width=33.87cm --prop height=0.3cm

# 左侧产品展示区 (内容区: 1-15cm)
officecli add "$OUTPUT" '/slide[3]' --type shape --prop geometry=rect --prop fill=F5F5F5 --prop x=1cm --prop y=1.5cm --prop width=14cm --prop height=16cm
officecli add "$OUTPUT" '/slide[3]' --type shape --prop geometry=ellipse --prop fill=FFE66D --prop opacity=0.3 --prop x=3cm --prop y=4cm --prop width=10cm --prop height=10cm
officecli add "$OUTPUT" '/slide[3]' --type shape --prop geometry=ellipse --prop fill=4ECDC4 --prop opacity=0.2 --prop x=5cm --prop y=6cm --prop width=6cm --prop height=6cm
...
officecli add "$OUTPUT" '/slide[3]' --type shape --prop geometry=roundRect --prop fill=FF6B6B --prop x=1.5cm --prop y=14.5cm --prop width=5cm --prop height=1.5cm
...
# 功能卡片1
officecli add "$OUTPUT" '/slide[3]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=17cm --prop y=4.5cm --prop width=15cm --prop height=3.5cm
officecli add "$OUTPUT" '/slide[3]' --type shape --prop geometry=ellipse --prop fill=FF6B6B --prop opacity=0.15 --prop x=18.5cm --prop y=5.2cm --prop width=2cm --prop height=2cm
...
# 功能卡片2
officecli add "$OUTPUT" '/slide[3]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=17cm --prop y=8.5cm --prop width=15cm --prop height=3.5cm
officecli add "$OUTPUT" '/slide[3]' --type shape --prop geometry=ellipse --prop fill=FFE66D --prop opacity=0.3 --prop x=18.5cm --prop y=9.2cm --prop width=2cm --prop height=2cm
...
# 功能卡片3
officecli add "$OUTPUT" '/slide[3]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=17cm --prop y=12.5cm --prop width=15cm --prop height=3.5cm
officecli add "$OUTPUT" '/slide[3]' --type shape --prop geometry=ellipse --prop fill=4ECDC4 --prop opacity=0.3 --prop x=18.5cm --prop y=13.2cm --prop width=2cm --prop height=2cm
...
# 右下角装饰
officecli add "$OUTPUT" '/slide[3]' --type shape --prop geometry=rect --prop fill=FFE66D --prop x=29cm --prop y=16cm --prop width=4.87cm --prop height=3.05cm
...
# 左侧装饰区
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=rect --prop fill=FF6B6B --prop opacity=0.1 --prop x=0cm --prop y=0cm --prop width=10cm --prop height=19.05cm

# 右侧装饰区
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=rect --prop fill=4ECDC4 --prop opacity=0.1 --prop x=27cm --prop y=0cm --prop width=6.87cm --prop height=19.05cm

# 左侧装饰圆点 (手动定义3个)
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=ellipse --prop fill=FF6B6B --prop opacity=0.2 --prop x=2cm --prop y=5cm --prop width=0.5cm --prop height=0.5cm
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=ellipse --prop fill=FFE66D --prop opacity=0.3 --prop x=3cm --prop y=7cm --prop width=0.4cm --prop height=0.4cm
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=ellipse --prop fill=4ECDC4 --prop opacity=0.25 --prop x=4cm --prop y=9cm --prop width=0.35cm --prop height=0.35cm
...
# 上排3个卡片 (内容区: 2-26cm)
# 卡片1
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=2cm --prop y=4cm --prop width=7.5cm --prop height=5cm
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=ellipse --prop fill=FF6B6B --prop x=5.25cm --prop y=4.8cm --prop width=1.5cm --prop height=1.5cm
...
# 卡片2
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=10.5cm --prop y=4cm --prop width=7.5cm --prop height=5cm
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=ellipse --prop fill=FFE66D --prop x=13.75cm --prop y=4.8cm --prop width=1.5cm --prop height=1.5cm
...
# 卡片3
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=19cm --prop y=4cm --prop width=7.5cm --prop height=5cm
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=ellipse --prop fill=4ECDC4 --prop x=22.25cm --prop y=4.8cm --prop width=1.5cm --prop height=1.5cm
...
# 下排3个卡片
# 卡片4
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=2cm --prop y=10.5cm --prop width=7.5cm --prop height=5cm
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=ellipse --prop fill=4ECDC4 --prop x=5.25cm --prop y=11.3cm --prop width=1.5cm --prop height=1.5cm
...
# 卡片5
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=10.5cm --prop y=10.5cm --prop width=7.5cm --prop height=5cm
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=ellipse --prop fill=FF6B6B --prop x=13.75cm --prop y=11.3cm --prop width=1.5cm --prop height=1.5cm
...
# 卡片6
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=19cm --prop y=10.5cm --prop width=7.5cm --prop height=5cm
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=ellipse --prop fill=FFE66D --prop x=22.25cm --prop y=11.3cm --prop width=1.5cm --prop height=1.5cm
...
# 底部装饰线
officecli add "$OUTPUT" '/slide[4]' --type shape --prop geometry=rect --prop fill=FF6B6B --prop x=0cm --prop y=18.8cm --prop width=33.87cm --prop height=0.25cm
...
# 左侧黄色装饰条 (装饰区)
officecli add "$OUTPUT" '/slide[5]' --type shape --prop geometry=rect --prop fill=FFE66D --prop x=0cm --prop y=0cm --prop width=4cm --prop height=19.05cm
...
# 左侧装饰圆点 (手动定义3个)
officecli add "$OUTPUT" '/slide[5]' --type shape --prop geometry=ellipse --prop fill=FF6B6B --prop opacity=0.2 --prop x=1cm --prop y=5cm --prop width=0.5cm --prop height=0.5cm
officecli add "$OUTPUT" '/slide[5]' --type shape --prop geometry=ellipse --prop fill=4ECDC4 --prop opacity=0.25 --prop x=2cm --prop y=7cm --prop width=0.4cm --prop height=0.4cm
officecli add "$OUTPUT" '/slide[5]' --type shape --prop geometry=ellipse --prop fill=FFE66D --prop opacity=0.3 --prop x=1.5cm --prop y=9cm --prop width=0.35cm --prop height=0.35cm
...
officecli add "$OUTPUT" '/slide[5]' --type shape --prop geometry=rect --prop fill=FF6B6B --prop x=6cm --prop y=9cm --prop width=4cm --prop height=0.15cm

# 客户信息卡片
officecli add "$OUTPUT" '/slide[5]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=6cm --prop y=10.5cm --prop width=12cm --prop height=3cm
officecli add "$OUTPUT" '/slide[5]' --type shape --prop geometry=ellipse --prop fill=4ECDC4 --prop opacity=0.3 --prop x=7.5cm --prop y=11.2cm --prop width=1.6cm --prop height=1.6cm
...
# 满意度指标
officecli add "$OUTPUT" '/slide[5]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=19cm --prop y=10.5cm --prop width=10cm --prop height=3cm
...
# 评价小卡片
officecli add "$OUTPUT" '/slide[5]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=6cm --prop y=15.5cm --prop width=8.5cm --prop height=2cm
...
officecli add "$OUTPUT" '/slide[5]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=15cm --prop y=15.5cm --prop width=8.5cm --prop height=2cm
...
officecli add "$OUTPUT" '/slide[5]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=24cm --prop y=15.5cm --prop width=8cm --prop height=2cm
...
# 顶部珊瑚橙大色块 (装饰区)
officecli add "$OUTPUT" '/slide[6]' --type shape --prop geometry=rect --prop fill=FF6B6B --prop x=0cm --prop y=0cm --prop width=33.87cm --prop height=8cm

# 右下角装饰色块
officecli add "$OUTPUT" '/slide[6]' --type shape --prop geometry=rect --prop fill=4ECDC4 --prop x=27cm --prop y=8cm --prop width=6.87cm --prop height=11.05cm

# 顶部装饰圆点 (手动定义，在装饰区域内)
officecli add "$OUTPUT" '/slide[6]' --type shape --prop geometry=ellipse --prop fill=FFFFFF --prop opacity=0.15 --prop x=5cm --prop y=2cm --prop width=0.5cm --prop height=0.5cm
officecli add "$OUTPUT" '/slide[6]' --type shape --prop geometry=ellipse --prop fill=FFE66D --prop opacity=0.2 --prop x=10cm --prop y=4cm --prop width=0.4cm --prop height=0.4cm
officecli add "$OUTPUT" '/slide[6]' --type shape --prop geometry=ellipse --prop fill=FFFFFF --prop opacity=0.1 --prop x=15cm --prop y=1cm --prop width=0.35cm --prop height=0.35cm

# 右侧装饰圆点
officecli add "$OUTPUT" '/slide[6]' --type shape --prop geometry=ellipse --prop fill=4ECDC4 --prop opacity=0.15 --prop x=29cm --prop y=10cm --prop width=0.5cm --prop height=0.5cm
officecli add "$OUTPUT" '/slide[6]' --type shape --prop geometry=ellipse --prop fill=FFFFFF --prop opacity=0.1 --prop x=30cm --prop y=13cm --prop width=0.4cm --prop height=0.4cm
officecli add "$OUTPUT" '/slide[6]' --type shape --prop geometry=ellipse --prop fill=4ECDC4 --prop opacity=0.1 --prop x=31cm --prop y=16cm --prop width=0.35cm --prop height=0.35cm
...
# 限时优惠标签
officecli add "$OUTPUT" '/slide[6]' --type shape --prop geometry=roundRect --prop fill=FFE66D --prop x=4cm --prop y=6cm --prop width=4cm --prop height=1cm
...
# 主按钮 (内容区)
officecli add "$OUTPUT" '/slide[6]' --type shape --prop geometry=roundRect --prop fill=FF6B6B --prop x=4cm --prop y=10cm --prop width=10cm --prop height=2.5cm
...
# 次按钮
officecli add "$OUTPUT" '/slide[6]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop line=FF6B6B --prop lineWidth=2pt --prop x=15cm --prop y=10cm --prop width=8cm --prop height=2.5cm
...
# 联系信息卡片 (内容区: 4-25cm)
officecli add "$OUTPUT" '/slide[6]' --type shape --prop geometry=roundRect --prop fill=FFFFFF --prop x=4cm --prop y=14cm --prop width=18cm --prop height=3.5cm
...
# 二维码占位 (装饰区内)
officecli add "$OUTPUT" '/slide[6]' --type shape --prop geometry=rect --prop fill=FFFFFF --prop x=28cm --prop y=10cm --prop width=5cm --prop height=5cm
