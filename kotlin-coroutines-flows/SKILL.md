...
```kotlin
// Avoid: leaks coroutines, no structured cancellation
GlobalScope.launch { fetchData() }

// Prefer: scoped to ViewModel lifecycle
viewModelScope.launch { fetchData() }

// Prefer: scoped to composable lifecycle
...
- Compose Multiplatform patterns: UI consumption of Flows
- Clean architecture: where coroutines fit in layers
