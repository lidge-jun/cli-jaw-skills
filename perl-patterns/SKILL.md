...
# Bad: Two-arg open (see perl-security)
open FH, $path;            # Avoid: shell injection risk
```
...
open FH, $filename;                     # Avoid: injection risk

# 2. Indirect object syntax
my $obj = new Foo(bar => 1);            # Bad: ambiguous parsing
