...
- Individual rule files: `rules/{prefix}-{name}.md`
- Full compiled reference: `AGENTS.md` (80 KB — contains all 57 rules with examples; consult individual rule files for targeted lookup)
