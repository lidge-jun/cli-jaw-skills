...
- **Return new instances** from cleaning/validation steps — keep parsed items immutable
...
- Skipping edge-case tests (malformed input, missing fields, encoding issues)
