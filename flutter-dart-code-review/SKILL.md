...
```dart
// Avoid — boolean flag soup allows impossible states
class UserState {
...
// Prefer (immutable approach) — sealed types make impossible states unrepresentable
...
// Prefer (reactive approach) — observable enum + data, mutations via reactivity API
