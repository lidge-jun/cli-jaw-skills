...
description: >
  Freight exception handling: shipment delays, damages, losses, carrier disputes.
  Includes escalation protocols, carrier-specific behaviors, claims procedures,
  and judgment frameworks.
---
...
Freight exceptions across all modes (LTL, FTL, parcel, intermodal, ocean, air). Covers TMS, WMS, carrier portals, claims management, and ERP order management integration.
