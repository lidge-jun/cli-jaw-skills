...
description: >
  Quality control, non-conformance investigation, root cause analysis,
  corrective action, and supplier quality management in regulated manufacturing.
  Includes NCR lifecycle, CAPA systems, SPC interpretation, and audit methodology
  across FDA, IATF 16949, and AS9100 environments.
---
...
Non-conformance lifecycle management in regulated manufacturing (FDA 21 CFR 820, IATF 16949, AS9100, ISO 13485). Integrates with QMS (MasterControl, ETQ, Veeva), SPC software (Minitab, InfinityQS), ERP (SAP QM, Oracle Quality), CMM/metrology, and supplier portals.
